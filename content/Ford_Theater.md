...
<!-- <img style="float: left;margin:0px 11px" width="300" src="ford_theater.jpg"> -->
...
<!-- <figure>
<img style="float: right;margin:0px 10px" width="230" src="Balcony_Image.jpg">
<figcaption class="figure-caption text-center">The Presidential Box where Lincoln sat</figcaption>
</figure> -->
...
It’s hard to imagine nowadays that someone could just walk up and try to 
